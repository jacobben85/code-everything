...
loadUrl = function (address, enableLogs) {
    ...
    if (enableLogs) console.log("Starting processing : " + address);
    ...
    page.onResourceReceived = function(response) {
        ...
        if (response.status !== 200 && response.status !== 201 && response.status !== 301 && response.status !== 304 && response.status !== null) {
